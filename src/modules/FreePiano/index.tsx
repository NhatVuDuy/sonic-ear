...
export function FreePianoModule() {
  ...
  return (
    <div className="flex flex-col gap-4 animate-[fadeUp_.32s_ease_both]">
      <div>
        <div className="font-display italic text-[1rem] text-[#a8a4cc]">Piano Tự do</div>
        <p className="mt-1 text-[.82rem] text-[#a8a4cc]">Nhấn phím để chơi · Scroll ngang để xem thêm</p>
      </div>
      <Card>
        <Piano startOctave={3} numOctaves={3} highlighted={highlighted} />
        <div className="mt-3">
          <div className="mb-2 font-mono text-[.68rem] uppercase tracking-widest text-[#a8a4cc]">Nghe Gam</div>
