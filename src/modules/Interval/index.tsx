...
import { INTERVALS, Interval, shuffle, NOTE_NAMES, NOTE_DISPLAY, shiftNote } from '@/theory'
...
export function IntervalModule() {
  ...
  return (
    <div className="flex flex-col gap-4 animate-[fadeUp_.32s_ease_both]">
      ...
      <Card>
        <CardTitle>Bàn phím — Oct 4–6</CardTitle>
        <Piano startOctave={4} numOctaves={3} highlighted={answered ? [q.n1, q.n2] : []} />
      </Card>
    </div>
  )
}
