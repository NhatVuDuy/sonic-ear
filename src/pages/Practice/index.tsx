...
const INFO: Record<Stage, string> = {
  interval: '<b style="color:#818cf8">Quãng nhạc</b> = khoảng cách cao độ.<br><br><b>P5</b> → "Star Wars"<br><b>P4</b> → "Here Comes the Bride"<br><b>M3</b> → "When the Saints"<br><b>m3</b> → "Smoke on the Water"<br><b>P8</b> → "Somewhere Over the Rainbow"',
  chord:    '<b style="color:#818cf8">Hợp âm</b> — nốt vang cùng nhau.<br><br><b>Major:</b> vui, sáng<br><b>Minor:</b> buồn, trầm<br><b>Dom7:</b> căng, muốn giải quyết<br><b>Maj7:</b> mơ màng, jazz<br><b>Dim:</b> u ám, bất an',
  scale:    '<b style="color:#818cf8">Điệu thức</b> = công thức khoảng cách nốt.<br><br><b>Major</b>: W-W-H-W-W-W-H (sáng)<br><b>Minor</b>: buồn, trầm<br><b>Harmonic Minor</b>: bí ẩn<br><b>Blues</b>: "xé lòng"<br><b>Pentatonic</b>: pop/rock',
  note:     '<b style="color:#818cf8">Cảm âm tuyệt đối vs tương đối</b><br><br><b>Tương đối</b>: nhận nốt dựa trên nốt tham chiếu.<br><br><b>Tuyệt đối</b>: nghe ra tên nốt ngay — bẩm sinh hoặc luyện rất lâu.',
  piano:    '<b style="color:#818cf8">Đàn tự do</b><br><br>Nhấn phím để chơi và lắng nghe sự khác biệt giữa Major và Minor.',
}
...
export function PracticePage() {
  ...
  return (
    <div className="flex flex-col" style={{ minHeight: 'calc(100vh - 110px)' }}>
      {/* Stage tabs */}
      <div className="flex overflow-x-auto border-b border-white/[0.08] bg-[rgba(11,9,24,.55)] px-2 sm:px-8">
        {STAGES.map(s => (
          <button
            key={s.id}
            ...
            className={`flex-shrink-0 border-b-2 px-3 sm:px-5 py-3 font-mono text-[.7rem] sm:text-[.75rem] tracking-[.08em] sm:tracking-[.12em] transition-all duration-300 cursor-pointer select-none ${
              s.id === currentStage
                ...
                : 'border-transparent text-[#8880b4] hover:text-[#818cf8]'
            }`}
          >
            <span className={`mr-1 inline-flex h-4 w-4 items-center justify-center rounded-full text-[.58rem] text-[#0b0918] ${s.id===currentStage?'bg-[#818cf8]':'bg-[#4338ca]'}`}>{s.num}</span>
            {s.label}
          </button>
        ))}
      </div>
      ...
      {/* Mobile stats bar */}
      <div className="md:hidden flex items-center gap-3 border-b border-white/[0.08] bg-[rgba(24,21,58,.65)] px-4 py-2">
        ...
        <div className="w-20 flex-shrink-0">
          <div className="mb-1 flex justify-between font-mono text-[.58rem] text-[#a8a4cc]">
      ...
      <div className="flex flex-1 flex-col md:flex-row">
        ...
        <div className="hidden md:flex w-72 min-w-[240px] flex-col gap-4 border-r border-white/[0.08] bg-[rgba(24,21,58,.65)] p-5">
          <div>
            <div className="font-display mb-2 italic text-[#a8a4cc]">Tiến độ hôm nay</div>
            ...
            <div className="mt-2.5">
              <div className="mb-1 flex justify-between font-mono text-[.64rem] text-[#a8a4cc]">
          ...
          <Card>
            ...
            <div
              className="text-[.83rem] leading-relaxed text-[#8880b4]"
